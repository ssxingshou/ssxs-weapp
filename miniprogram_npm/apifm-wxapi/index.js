  ...
  (function (modules) { // webpackBootstrap
    ...
    ([
      ...
      (function (module, exports, __webpack_require__) {
        ...
        // var subDomain = '07a23a6c393bdecea52ea97c536bcc76';
        var API_BASE_URL = 'https://qa.cloudapi.ssxingshou.com';
        var subDomain = 'api/v1/home';
        ...
        module.exports = {
          ...
          queryConfigValue: function queryConfigValue(key, appid) {
            return request('/enterprise/config/value', true, 'post', {
              //return request('/config/value', true, 'get', {
              appletAppId: appid,
              key: key
            });
          },
          queryConfigBatch: function queryConfigBatch(keys, appid) {
            return request('/enterprise/config/values', true, 'post', {
          ...
          kanjiaSet: function kanjiaSet(goodsId) {
            return request('/shop/goods/kanjia/set/v2', true, 'get', {
              goodsId: goodsId
            });
          },
          ...
          checkToken: function checkToken(token, appid) {
            //return request('/user/check-token', true, 'get', {
            return request('/weixin/checkToken', true, 'post', {
              appletAppId: appid,
              token: token
            });
          },
          ...
          payQuery: function payQuery(token, outTradeId) {
            return request('/pay/query', true, 'get', {
              token: token,
          ...
          login_wx: function login_wx(code, appid) {
            return request('/weixin/wxaLogin', true, 'post', {
              appletAppId: appid,
              code: code,
              type: 2
            });
          ...
          register_complex: function register_complex(data) {
            return request('/weixin/wxaLoginAndRegister', true, 'post', data);
          },
          ...
          bindMobileWxa: function bindMobileWxa(appid, token, encryptedData, iv) {
            //return request('/user/wxapp/bindMobile', true, 'post', {
            return request('/weixin/bindTelephone', true, 'post', {
              appletAppId: appid,
              token: token,
              encryptedData: encryptedData,
              iv: iv,
          ...
          // 会员信息
          userDetail: function userDetail(token, appid) {
            return request('/enterprise/weixin/member/detail', true, 'post', {
              appletAppId: appid,
              token: token
            });
          },
          ...
          cmsCategoryDetail: function cmsCategoryDetail(id) {
            return request('/cms/category/info', true, 'get', {
              id: id
            });
          },
          ...
          cmsPage: function cmsPage(key) {
            return request('/cms/page/info/v2', true, 'get', {
              key: key
            });
          },
          ...
          fetchMyShops: function fetchMyShops(token) {
            return request('/shop/subshop/my', true, 'get', {
              token: token
            });
          },
          ...
          luckyInfo: function luckyInfo(id) {
            return request('/luckyInfo/info/v2', true, 'get', {
              id: id
            });
          },
          ...
          cmsArticleFavPut: function cmsArticleFavPut(token, newsId) {
            return request('/cms/news/fav/add', true, 'post', {
              token: token,
              newsId: newsId
            });
          },
          cmsArticleFavCheck: function cmsArticleFavCheck(token, newsId) {
            return request('/cms/news/fav/check', true, 'get', {
              token: token,
              newsId: newsId
            });
          },
          ...
          cmsArticleFavDeleteById: function cmsArticleFavDeleteById(token, id) {
            return request('/cms/news/fav/delete', true, 'post', {
              token: token,
              id: id
            });
          },
